...
<?= $this->section('title') ?>Schedule Appointment<?= $this->endSection() ?>
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">Schedule Appointment</h1>
                        ...
                        <select name="patient_id" id="patient_id" class="form-select select2" required>
                            ...
                            <?php foreach ($patients as $patient): ?>
                                <option value="<?= $patient['id'] ?>" 
                                        <?= old('patient_id', $selected_patient['id'] ?? '') == $patient['id'] ? 'selected' : '' ?>>
                        ...
                        <select name="doctor_id" id="doctor_id" class="form-select select2" required>
                            ...
                            <?php foreach ($doctors as $doctor): ?>
                                <option value="<?= $doctor['id'] ?>" 
                                        ...
                                        <?= old('doctor_id', $selected_doctor['id'] ?? '') == $doctor['id'] ? 'selected' : '' ?>>
